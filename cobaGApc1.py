# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 10:24:36 2019
...
#        dataset = pd.read_csv('blood.csv', skiprows = [0], header=None)
        dataset= pd.read_csv('dataset/pc1.csv', skiprows = range(0,356), header = None)
        classs= dataset[21]
...
#            print("\nAkurasi : " + str(akurasi) +"%")  
        print('Akurasi rata-rata SVM : ' + repr(svm_accuracy / n_fold))
#        print (classification_report(y_tes,svm_res))
#        print(confusion_matrix(y_tes, svm_res))
